...
data = pd.read_csv("/Users/francoisramon/Desktop/These/Catatonia/data/brain_age_vs_statut.csv")
...
X = data.drop(columns=["statut","Age","N_anonymisation","Subject","Report.date","Quality.control"])
